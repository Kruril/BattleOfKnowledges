...
public abstract class BackgroundLoader {
    ...
    public static Background builderBackGround() {
        return new Background(new BackgroundImage(new Image("asset/images/background/Background.png"), BackgroundRepeat.NO_REPEAT,
    ...
    public static Background buildBtnBackGround() {
        return new Background(new BackgroundImage(new Image("asset/images/background/button/button.png"), BackgroundRepeat.SPACE,
    ...
    public static Background buildBookGame() {
        return new Background(new BackgroundImage(new Image("asset/images/background/mainGame/book.png"), BackgroundRepeat.NO_REPEAT,
                BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,
    ...
    public static Background buildDialogBackGround(double wight, double height) {
        return new Background(new BackgroundImage(new Image("asset/images/element/ExitMenu.png"), BackgroundRepeat.NO_REPEAT,
                BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,
    ...
    public static Background buildTimerBackGround() {
        return new Background(new BackgroundImage(new Image("asset/images/element/PointBoard.png"), BackgroundRepeat.NO_REPEAT,
                BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,
